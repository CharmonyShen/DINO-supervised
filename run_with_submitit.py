...
def parse_args():
    ...
    parser.add_argument("--partition", default="gpgpu", type=str, help="Partition where to submit")
    parser.add_argument("--qos", default="gpgpumse", type=str)
...
def get_shared_folder() -> Path:
    user = os.getenv("USER")
    if Path("/data/scratch/projects/punim1671/output/pretrain_test").is_dir():
        p = Path(f"/data/scratch/projects/punim1671/output/pretrain_test/checkpoint")
