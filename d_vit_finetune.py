...
def land_use_classify(args):
    ...
    elif args.arch == 'supervised':
        pretrain_model = torchvision_models.vit_b_16(pretrained=True)
        pretrain_model.heads.add_module('classifier', nn.Linear(1000, args.num_labels))
        print(f"Pretrained {args.arch} VIT built.")
    else:
    ...
    if args.evaluate:
        ...
        #     '/data/scratch/projects/punim1672/dino-main-xy/outputs/wr101_1/luc/lr003/40313432luc_checkpoint.pth.tar',
